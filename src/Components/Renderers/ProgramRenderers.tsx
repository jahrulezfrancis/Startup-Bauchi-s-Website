    ...
    return (
        <Stack>
            <Flex justify={"center"} gap={50} wrap={"wrap"}>
                <ProgramsCard index={2} icon={<PiPresentationLight color={secondaryColor} fontSize={50} />} title="Startup Showcases" description="Opportunities for startups to showcase their products, services, and innovations to potential investors, customers, and partners." />
